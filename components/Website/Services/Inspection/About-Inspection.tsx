...
const chips = [
  { label: "Inspection Types", value: "Quality · Safety · Compliance · Pre-shipment" },
  { label: "Guided By",        value: "International Standards" },
  { label: "Output",           value: "Inspection Certificate" },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-14 items-center py-12 lg:py-16">
          ...
          >
            ...
            <p className="text-base text-slate-500 leading-relaxed mb-8 max-w-lg">
              Systematic, professional evaluation of products, materials, equipment, and facilities —
              confirming compliance with defined standards, customer requirements, and regulatory benchmarks.
            </p>
          ...
          >
            <div className="relative rounded-2xl overflow-hidden shadow-md">
              <Image
                ...
                alt="Inspection Services — TMGSSL"
                width={560}
                height={420}
              ...
              <div className="absolute bottom-4 left-4 rounded-xl bg-white/92 backdrop-blur-sm px-4 py-2.5 shadow-lg">
                <span className="text-xs font-bold text-slate-800">ISO 17020 Compliant</span>
              </div>
            </div>
          </motion.div>
        </div>
