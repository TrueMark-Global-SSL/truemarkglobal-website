              ...
              <div
                ...
                >
                  ...
                  <ul>
                    ...
                    <li>
                      <a href="/who_we_are" className="mb-3 inline-block hover:text-primary">
                        About Us
                      </a>
                    </li>
                    <li>
                      <a href="/courses" className="mb-3 inline-block hover:text-primary">
                        Courses
                      </a>
                    </li>
                    <li>
                      <a href="/certificate-register" className="mb-3 inline-block hover:text-primary">
          ...
          <div className="flex text-sm flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            >
              <ul className="flex items-center gap-8">
                <li>
                  <a href="/policy/privacy" className="hover:text-primary">
                    Privacy Policy
                  </a>
                </li>
                <li>
            ...
            >
              <p>
                &copy; {new Date().getFullYear()} TrueMark Global Standards &amp; Solutions Limited. All rights reserved.
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              className="animate_top"
            >
              <ul className="flex items-center gap-6 pr-14">
                <li>
